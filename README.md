# Simple python module boilerplate

A cookiecutter to easily create python libs that are ready to push to pypi.

## How to start
```
$ pip install cookiecutter
$ cookiecutter https://github.com/itsmeale/python-lib-boilerplate
```
